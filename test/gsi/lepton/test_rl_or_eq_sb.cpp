...
RC_GTEST_FIXTURE_PROP(LeptonAPUCTest, rl_or_eq_sb, ()) {
  ...
  lepton_rl_or_eq_sb(apuc, mask, vrs, num_vrs);
  ...
  apuc->in_place = false;
  lepton_wordline_map_t *patch = lepton_rl_or_eq_sb(apuc, mask, vrs, num_vrs);
