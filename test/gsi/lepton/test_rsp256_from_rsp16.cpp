...
RC_GTEST_FIXTURE_PROP(LeptonAPUCTest, rsp256_from_rsp16, ()) {
  ...
  lepton_rsp256_from_rsp16(apuc);
  RC_ASSERT(lepton_rsp256_eq_rsp16(&apuc->rsp256, &apuc->rsp16));

  lepton_randomize_rsp256(&apuc->rsp256, rsp256_seed);
  lepton_randomize_rsp16(&apuc->rsp16, rsp16_seed);

  apuc->in_place = false;
  lepton_rsp256_t *patch = lepton_rsp256_from_rsp16(apuc);
