...
TEST_F(LeptonAPUCTest, rl_xor_eq_2_sbs_in_place) {
...
TEST_F(LeptonAPUCTest, rl_xor_eq_2_sbs_w_patch) {
  apuc->in_place = false;
  lepton_vr_t *vr1 = &apuc->vrs[1];
  lepton_vr_t *vr2 = &apuc->vrs[2];
  size_t num_vrs = 2;
...
TEST_F(LeptonAPUCTest, rl_xor_eq_sb_in_place) {
...
TEST_F(LeptonAPUCTest, rl_xor_eq_sb_w_patch) {
  apuc->in_place = false;
  lepton_vr_t *vr = &apuc->vrs[1];
  size_t num_vrs = 1;
  lepton_vr_t *vrs[] = { vr };
