...
RC_GTEST_FIXTURE_PROP(LeptonAPUCTest, rl_xor_eq_sb, ()) {
  ...
  lepton_rl_xor_eq_sb(apuc, mask, vrs, num_vrs);
  ...
  apuc->in_place = false;
  lepton_wordline_map_t *patch = lepton_rl_xor_eq_sb(apuc, mask, vrs, num_vrs);
