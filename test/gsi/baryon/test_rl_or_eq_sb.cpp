...
RC_GTEST_FIXTURE_PROP(BaryonAPUCTest, rl_or_eq_sb, ()) {
  ...
  baryon_rl_or_eq_sb(apuc, mask, vrs, num_vrs);
  ...
  apuc->in_place = false;
  baryon_wordline_map_t *patch = baryon_rl_or_eq_sb(apuc, mask, vrs, num_vrs);
